      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 rounded-xl border border-white/5 bg-[#0B0F19] p-5 shadow-lg space-y-4">
          <div className="flex items-center gap-2 border-b border-white/5 pb-3">
            <CircleDollarSign className="h-4.5 w-4.5 text-purple-400" />
          ...
          <form onSubmit={handleApply} className="space-y-4">
            ...
            {selectedProduct && (
              <div className="rounded-lg bg-[#06080E]/60 border border-white/5 p-4 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
                ...
                <div>
                  ...
                  <span className="text-purple-400 font-bold">{selectedProduct.interestRate}% flat rate</span>
                </div>
            ...
            <button
              ...
              className="w-full rounded-lg bg-purple-600 hover:bg-purple-500 py-2 text-xs font-semibold text-white transition active:scale-95"
            >
          ...
          <div>
            ...
            {score ? (
              <div className="text-center py-4 space-y-2.5">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full border-4 border-sky-400/20 bg-sky-500/5">
                  <span className="text-2xl font-bold text-sky-400 font-mono">{score.score}</span>
                </div>
